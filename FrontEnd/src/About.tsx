    ...
    <>
      ...
      <section className="flex w-full mx-auto relative flex-col sm:flex-row mt-14">
        ...
        <section className="flex w-full mx-auto relative flex-col justify-center items-center h-full gap-12 mt-12 sm:ml-64">
          <img
            src={SaltyNote}
            alt="Orange note that says salt notes"
            className="w-[240px] sm:w-[350px]"
          />
          <h2 className="text-xl">Welcome to Salt Notes</h2>
          <p>
            Click on the sidebar to choose a day! (Hamburger Icon if you're on mobile)
          </p>
        </section>
      </section>
    </>
